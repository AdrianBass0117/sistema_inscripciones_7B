            ...
            <div class="sidebar-content">
                ...
                <nav class="sidebar-nav">
                    <div class="nav-section">
                        ...
                        <a href="{{ route('aspirante') }}" class="nav-item active">
                            <i class="fas fa-home"></i>
                            <span>Inicio</span>
                        </a>
                        <a href="{{ route('aspirante.notificaciones') }}" class="nav-item">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="{{ route('aspirante.cuenta') }}" class="nav-item">
        ...
        <main class="main-content">
            <header class="top-bar">
                ...
                <div class="page-actions">
                    <a href="{{ route('aspirante.notificaciones') }}">
