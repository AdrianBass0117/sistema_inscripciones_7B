            ...
            <div class="sidebar-content">
                ...
                <nav class="sidebar-nav">
                    <div class="nav-section">
                        ...
                        <a href="{{ route('comite') }}" class="nav-item active">
                            <i class="fas fa-home"></i>
                            <span>Inicio</span>
                        </a>

                        <div class="nav-title">Eventos</div>
                        <a href="{{ route('comite.aspirantes') }}" class="nav-item">
                            <i class="fas fa-users"></i>
                            <span>Aspirantes</span>
                        </a>
                        <a href="{{ route('comite.disciplinas') }}" class="nav-item">
                            <i class="fas fa-trophy"></i>
                            <span>Disciplinas</span>
                        </a>

                        <div class="nav-title">Sistema</div>
                        <a href="{{ route('comite.validacion') }}" class="nav-item">
                            <i class="fas fa-clipboard-check"></i>
                            <span>Validación</span>
                        </a>
                        <a href="{{ route('comite.reportes') }}" class="nav-item">
                            <i class="fas fa-file-alt"></i>
                            <span>Reportes</span>
                        </a>
                        <a href="{{ route('comite.notificaciones') }}" class="nav-item">
                            <i class="fas fa-bell"></i>
                            <span>Notificaciones</span>
                        </a>

                        <div class="nav-title">Usuario</div>
                    ...
                    <div class="user-info">
                        <div class="user-avatar">
                            @php
                                ...
                                // Crear iniciales desde el email (primera letra antes del @ y primera después)
                                $initials = 'CO'; // Por defecto
                                if ($email) {
                        ...
                        <div class="user-details">
                            <h4 title="{{ session('user_email') ?? 'Usuario Comité' }}">
                                @php
                                    $email = session('user_email') ?? '';
        ...
        <main class="main-content">
            <header class="top-bar">
                ...
                <div class="page-actions">
                    <a href="{{ route('comite.notificaciones') }}">
